...
return [
    'Names' => [
        ...
        'en' => 'engleză',
        'en_001' => 'engleză (Lume)',
        'en_150' => 'engleză (Europa)',
        'en_AE' => 'engleză (Emiratele Arabe Unite)',
        ...
        'ff_Adlm_GN' => 'fulah (adlam, Guineea)',
        'ff_Adlm_GW' => 'fulah (adlam, Guineea-Bissau)',
        ...
        'ff_CM' => 'fulah (Camerun)',
        'ff_GN' => 'fulah (Guineea)',
        'ff_Latn' => 'fulah (latină)',
        'ff_Latn_BF' => 'fulah (latină, Burkina Faso)',
        'ff_Latn_CM' => 'fulah (latină, Camerun)',
        'ff_Latn_GH' => 'fulah (latină, Ghana)',
        'ff_Latn_GM' => 'fulah (latină, Gambia)',
        'ff_Latn_GN' => 'fulah (latină, Guineea)',
        'ff_Latn_GW' => 'fulah (latină, Guineea-Bissau)',
        'ff_Latn_LR' => 'fulah (latină, Liberia)',
        'ff_Latn_MR' => 'fulah (latină, Mauritania)',
        'ff_Latn_NE' => 'fulah (latină, Niger)',
        'ff_Latn_NG' => 'fulah (latină, Nigeria)',
        'ff_Latn_SL' => 'fulah (latină, Sierra Leone)',
        'ff_Latn_SN' => 'fulah (latină, Senegal)',
        'ff_MR' => 'fulah (Mauritania)',
        'ff_SN' => 'fulah (Senegal)',
        'fi' => 'finlandeză',
        'fi_FI' => 'finlandeză (Finlanda)',
        'fo' => 'feroeză',
        'fo_DK' => 'feroeză (Danemarca)',
        'fo_FO' => 'feroeză (Insulele Feroe)',
        'fr' => 'franceză',
        'fr_BE' => 'franceză (Belgia)',
        'fr_BF' => 'franceză (Burkina Faso)',
        'fr_BI' => 'franceză (Burundi)',
        'fr_BJ' => 'franceză (Benin)',
        'fr_BL' => 'franceză (Saint-Barthélemy)',
        ...
        'hi' => 'hindi',
        'hi_IN' => 'hindi (India)',
        'hi_Latn' => 'hindi (latină)',
        'hi_Latn_IN' => 'hindi (latină, India)',
        'hr' => 'croată',
        ...
        'pt_MO' => 'portugheză (R.A.S. Macao, China)',
        'pt_MZ' => 'portugheză (Mozambic)',
        'pt_PT' => 'portugheză (Portugalia)',
        'pt_ST' => 'portugheză (São Tomé și Príncipe)',
        'pt_TL' => 'portugheză (Timor-Leste)',
        'qu' => 'quechua',
        ...
        'sa' => 'sanscrită',
        'sa_IN' => 'sanscrită (India)',
        'sc' => 'sardiniană',
        'sc_IT' => 'sardiniană (Italia)',
        'sd' => 'sindhi',
        'sd_Arab' => 'sindhi (arabă)',
        'sd_Arab_PK' => 'sindhi (arabă, Pakistan)',
        ...
        'sq_MK' => 'albaneză (Macedonia de Nord)',
        'sr' => 'sârbă',
        ...
        'su_Latn_ID' => 'sundaneză (latină, Indonezia)',
        'sv' => 'suedeză',
