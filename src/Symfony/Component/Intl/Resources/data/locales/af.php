...
return [
    'Names' => [
        ...
        'en_AS' => 'Engels (Amerikaanse Samoa)',
        'en_AT' => 'Engels (Oostenryk)',
        ...
        'en_BZ' => 'Engels (Belize)',
        'en_CA' => 'Engels (Kanada)',
        'en_CC' => 'Engels (Kokoseilande)',
        'en_CH' => 'Engels (Switserland)',
        ...
        'en_MP' => 'Engels (Noord-Mariane-eilande)',
        'en_MS' => 'Engels (Montserrat)',
        'en_MT' => 'Engels (Malta)',
        'en_MU' => 'Engels (Mauritius)',
        'en_MV' => 'Engels (Maledive)',
        'en_MW' => 'Engels (Malawi)',
        ...
        'en_VI' => 'Engels (VSA se Maagde-eilande)',
        ...
        'fi_FI' => 'Fins (Finland)',
        'fo' => 'Faroëes',
        'fo_DK' => 'Faroëes (Denemarke)',
        'fo_FO' => 'Faroëes (Faroëreilande)',
        'fr' => 'Frans',
        'fr_BE' => 'Frans (België)',
        ...
        'ga' => 'Iers',
        'ga_GB' => 'Iers (Verenigde Koninkryk)',
        'ga_IE' => 'Iers (Ierland)',
        'gd' => 'Skotse Gallies',
        ...
        'nb' => 'Boeknoors',
        'nb_NO' => 'Boeknoors (Noorweë)',
        'nb_SJ' => 'Boeknoors (Spitsbergen en Jan Mayen)',
        'nd' => 'Noord-Ndebele',
        ...
        'sa' => 'Sanskrit',
        'sa_IN' => 'Sanskrit (Indië)',
        'sc' => 'Sardinies',
        'sc_IT' => 'Sardinies (Italië)',
        'sd' => 'Sindhi',
        'sd_Arab' => 'Sindhi (Arabies)',
        'sd_Arab_PK' => 'Sindhi (Arabies, Pakistan)',
        'sd_Deva' => 'Sindhi (Devanagari)',
        'sd_Deva_IN' => 'Sindhi (Devanagari, Indië)',
        'sd_IN' => 'Sindhi (Indië)',
        'sd_PK' => 'Sindhi (Pakistan)',
        'se' => 'Noord-Sami',
        'se_FI' => 'Noord-Sami (Finland)',
        'se_NO' => 'Noord-Sami (Noorweë)',
        'se_SE' => 'Noord-Sami (Swede)',
        'sg' => 'Sango',
        'sg_CF' => 'Sango (Sentraal-Afrikaanse Republiek)',
        'sh' => 'Serwo-Kroaties',
        'sh_BA' => 'Serwo-Kroaties (Bosnië en Herzegowina)',
        'si' => 'Sinhala',
        ...
        'su_Latn_ID' => 'Sundanees (Latyn, Indonesië)',
        'sv' => 'Sweeds',
        'sv_AX' => 'Sweeds (Ålandeilande)',
        'sv_FI' => 'Sweeds (Finland)',
        'sv_SE' => 'Sweeds (Swede)',
        'sw' => 'Swahili',
        'sw_CD' => 'Swahili (Demokratiese Republiek van die Kongo)',
        'sw_KE' => 'Swahili (Kenia)',
