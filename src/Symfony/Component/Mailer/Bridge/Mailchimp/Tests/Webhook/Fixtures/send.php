...
$wh = new MailerDeliveryEvent(MailerDeliveryEvent::RECEIVED, '7761636', json_decode(file_get_contents(str_replace('.php', '.json', __FILE__)), true, flags: JSON_THROW_ON_ERROR)['mandrill_events'][0]);
