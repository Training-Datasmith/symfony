...
class Country_Type extends Abstract_Type
{
    public function configure_options(Options_Resolver $resolver): void
    {
        $resolver->set_defaults(['choice_loader' => function (Options $options): \Symfony\Component\Form\Choice_List\Factory\Cache\Choice_Loader {
            ...
            return Choice_List::loader($this, new Intl_Callback_Choice_Loader(static fn(): array => array_flip($alpha3 ? Countries::get_alpha3names($choice_translation_locale) : Countries::get_names($choice_translation_locale))), [$choice_translation_locale, $alpha3]);
        }, 'choice_translation_domain' => false, 'choice_translation_locale' => null, 'alpha3' => false, 'invalid_message' => 'Please select a valid country.']);
