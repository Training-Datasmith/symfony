...
class Env_Configurator extends Param_Configurator
{
    /**
     * @var string[]
     */
    ...
    {
        $processor = strtolower((string) preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\d])([A-Z])/'], '\1_\2', $name));
     ...
     * @return $this
     */
    public function query_string(): static
    {
     ...
     * @return $this
     */
    public function default(string $fallback_param): static
    {
        array_unshift($this->stack, 'default', $fallback_param);
        return $this;
    }
    /**
     * @return $this
     ...
     * @return $this
     */
    public function enum(string $backed_enum_class_name): static
    {
        array_unshift($this->stack, 'enum', $backed_enum_class_name);
        return $this;
    }
}