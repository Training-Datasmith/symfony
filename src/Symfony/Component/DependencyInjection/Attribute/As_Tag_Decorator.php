...
class As_Tag_Decorator
{
     ...
     */
    public function __construct(public string $tag, public int $priority = 0, public int $on_invalid = Container_Interface::EXCEPTION_ON_INVALID_REFERENCE)
    {
    }
}