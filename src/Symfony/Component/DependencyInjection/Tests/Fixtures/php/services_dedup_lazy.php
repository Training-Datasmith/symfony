...
class ProjectServiceContainer extends Container
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['bar'] = new \ReflectionClass('stdClass')->newLazyGhost(static function ($proxy) use ($container) {
                self::getBarService($container, $proxy);
            });
        }
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['foo'] = new \ReflectionClass('stdClass')->newLazyGhost(static function ($proxy) use ($container) {
                self::getFooService($container, $proxy);
            });
        }
