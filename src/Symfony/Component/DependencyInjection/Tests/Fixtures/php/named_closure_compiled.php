...
class ProjectServiceContainer extends Container
{
    ...
    {
        return $container->services['from_callable'] = new class (fn () => 'Testing\\NamedClosure\\NamedClosureClass') extends \Symfony\Component\DependencyInjection\Argument\LazyClosure implements \Testing\NamedClosure\NamedClosureInterface {
            public function theMethod()
            {
                return $this->service->getInstance(...\func_get_args());
            }
        };
    }
