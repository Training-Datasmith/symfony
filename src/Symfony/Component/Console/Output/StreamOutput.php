 ...
 */
class Stream_Output extends Output
{
    /** @var resource */
    private $stream;
    /**
     ...
     */
    public function __construct($stream, int $verbosity = self::VERBOSITY_NORMAL, ?bool $decorated = null, ?Output_Formatter_Interface $formatter = null)
    {
        if (!\is_resource($stream) || 'stream' !== get_resource_type($stream)) {
            throw new InvalidArgumentException('The StreamOutput class needs a stream as its first argument.');
        }
        $this->stream = $stream;
        $decorated ??= $this->has_color_support();
     ...
     */
    protected function has_color_support(): bool
    {
