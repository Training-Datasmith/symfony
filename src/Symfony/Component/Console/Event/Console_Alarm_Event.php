...
final class Console_Alarm_Event extends Console_Event
{
    public function __construct(Command $command, Input_Interface $input, Output_Interface $output, private int|false $exit_code = 0)
    {
