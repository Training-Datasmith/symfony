...
class GithubActionReporter
{
    ...
    private function log(string $type, string $message, ?string $file = null, ?int $line = null, ?int $col = null): void
    {
        ...
        $this->output->writeln(\sprintf('::%s file=%s,line=%s,col=%s::%s', $type, strtr($file, self::ESCAPED_PROPERTIES), strtr((string) ($line ?? 1), self::ESCAPED_PROPERTIES), strtr((string) ($col ?? 0), self::ESCAPED_PROPERTIES), $message));
    }
}
