<!-- <?php 
echo $_message = \sprintf('%s (%d %s)', $exception_message, $status_code, $status_text);
?> -->
<!DOCTYPE html>
<html lang="en">
    <head>
...
?></style>
    ...
    <body>
        ...
        <?php 
if (class_exists(\Symfony\Component\Http_Kernel\Kernel::class)) {
    ?>
            <header>
                <div class="container">
                    <h1 class="logo"><?php 
    ...
    echo Symfony\Component\Http_Kernel\Kernel::VERSION;
    ?>/index.html">
                            <span class="icon"><?php 
