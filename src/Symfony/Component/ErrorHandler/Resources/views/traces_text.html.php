        ...
        <tr>
            <th class="sf-toggle" data-toggle-selector="#trace-text-<?= $index; ?>" data-toggle-initial="<?= 1 === $index ? 'display' : ''; ?>">
                <div class="trace-class">
                    ...
                    <?php } ?>
                    <?= ($parts = explode('\\', (string) $exception['class'])) ? end($parts) : ''; ?>
...
<?php
                    ...
                    foreach ($exception['trace'] as $trace) {
                        ...
                        if ($trace['file'] && $trace['line']) {
                            echo($trace['function'] ? "\n     (" : 'at ').strtr(strip_tags((string) $this->formatFile($trace['file'], $trace['line'])), [' at line '.$trace['line'] => '']).':'.$trace['line'].($trace['function'] ? ')' : '');
                        }
                    }
                    ?>
                </pre>
