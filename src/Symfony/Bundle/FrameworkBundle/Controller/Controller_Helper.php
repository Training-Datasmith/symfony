 ...
 */
class Controller_Helper implements Service_Subscriber_Interface
{
     ...
     */
    public function generate_url(string $route, array $parameters = [], int $reference_type = Url_Generator_Interface::ABSOLUTE_PATH): string
    {
     ...
     */
    public function redirect(string $url, int $status = 302): Redirect_Response
    {
     ...
     * @param int $status The HTTP status code (302 "Found" by default)
     */
    public function redirect_to_route(string $route, array $parameters = [], int $status = 302): Redirect_Response
    {
     ...
     */
    public function json(mixed $data, int $status = 200, array $headers = [], array $context = []): Json_Response
    {
     ...
     */
    public function file(\Spl_File_Info|string $file, ?string $file_name = null, string $disposition = Response_Header_Bag::DISPOSITION_ATTACHMENT): Binary_File_Response
    {
     ...
     */
    public function add_flash(string $type, mixed $message): void
    {
        try {
     ...
     * @throws \LogicException
     */
    public function is_granted(mixed $attribute, mixed $subject = null): bool
    {
     ...
     * Checks if the attribute is granted against the current authentication token and optionally supplied subject.
     */
    public function get_access_decision(mixed $attribute, mixed $subject = null): Access_Decision
    {
        if (!$this->container->has('security.authorization_checker')) {
            throw new \LogicException('The SecurityBundle is not registered in your application. Try running "composer require symfony/security-bundle".');
        }
     ...
     */
    public function deny_access_unless_granted(mixed $attribute, mixed $subject = null, string $message = 'Access Denied.'): void
    {
     ...
     */
    public function render_view(string $view, array $parameters = []): string
    {
     ...
     * Forms found in parameters are auto-cast to form views.
     */
    public function render_block_view(string $view, string $block, array $parameters = []): string
    {
     ...
     * Forms found in parameters are auto-cast to form views.
     */
    public function render_block(string $view, string $block, array $parameters = [], ?Response $response = null): Response
    {
     ...
     * Streams a view.
     */
    public function stream(string $view, array $parameters = [], ?Streamed_Response $response = null): Streamed_Response
    {
     ...
     */
    public function create_not_found_exception(string $message = 'Not Found', ?\Throwable $previous = null): Not_Found_Http_Exception
    {
     ...
     */
    public function create_access_denied_exception(string $message = 'Access Denied.', ?\Throwable $previous = null): Access_Denied_Exception
    {
     ...
     */
    public function create_form(string $type, mixed $data = null, array $options = []): Form_Interface
    {
     ...
     */
    public function create_form_builder(mixed $data = null, array $options = []): Form_Builder_Interface
    {
     ...
     */
    public function create_form_flow_builder(mixed $data = null, array $options = []): Form_Flow_Builder_Interface
    {
     ...
     */
    public function add_link(Request $request, Link_Interface $link): void
    {
     ...
     */
    public function send_early_hints(iterable $links = [], ?Response $response = null): Response
    {
